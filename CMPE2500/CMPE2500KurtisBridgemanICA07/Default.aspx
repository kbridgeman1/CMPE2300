    ...
    <div id="content">
        ...
        <table id="mainTable">
            ...
            <tr>
                ...
                <td rowspan="3"><asp:ListBox ID="lbSavedColors" runat="server" OnSelectedIndexChanged="lbSavedColors_SelectedIndexChanged" style="width:98%; height:100%" AutoPostBack="True"></asp:ListBox></td>
            </tr>
            <tr>
