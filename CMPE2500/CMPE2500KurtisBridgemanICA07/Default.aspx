    ...
    <div id="content">
        ...
        <table id="mainTable">
            ...
            <tr>
                ...
                <td id="rblistCell">
                    <asp:RadioButtonList ID="rblGreen" runat="server" RepeatDirection="Horizontal" style="width:100%; height:100%; border:1px solid blue">
<%--                    <asp:ListItem Value="0" Selected="True">0%</asp:ListItem>
                ...
                <td rowspan="3"><asp:ListBox ID="lbSavedColors" runat="server" OnSelectedIndexChanged="lbSavedColors_SelectedIndexChanged" Rows="6" style="width:98%; height:100%" AutoPostBack="True"></asp:ListBox></td>
            </tr>
            <tr>
